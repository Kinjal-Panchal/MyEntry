...
//  Danfo_Rider
//
//  Created by panchal kinjal on 30/03/21.
//
...
enum NotificationKeys  : String {
    case kuserProfileKey = "updateProfile"
    case kUpdateEventList = "updateEventList"
}
...
struct NotificationObeserverKeys  {
    static let ProfiledataRefresh = NSNotification.Name("ProfileRefresh")
}
