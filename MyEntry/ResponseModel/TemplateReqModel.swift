//
//  TemplateReqModel.swift
//  MyEntry
//
//  Created by Kinjal panchal on 22/11/21.
//

import Foundation

class RootTemplateList : Codable {
        ...
        required init(from decoder: Decoder) throws {
            ...
            data = try? values.decodeIfPresent([TemplateList].self, forKey: .data)
